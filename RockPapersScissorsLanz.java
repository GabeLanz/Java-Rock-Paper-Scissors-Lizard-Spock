...
public class RockPapersScissorsLanz {
	...
	public static void main(String[] args) {
		...
		System.out.print("Player 1: Enter R -for Rock, P -for Paper, S -for Scissors, L -for Lizard, or SP -for Spock: ");
		...
		// comparison).
			...
			if (player1.equals("P")) {
				...
				if (player2.equals("SP"))
					System.out.println("Spock vaporizes Scissors, player 2 wins!");
